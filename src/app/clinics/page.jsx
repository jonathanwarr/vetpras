...
export default function ClinicsPage() {
  ...
  const [searchQuery, setSearchQuery] = useState(''); // manual typing
  const [categoryQuery, setCategoryQuery] = useState(''); // category selection
  ...
  const handleCategoryChange = (categoryName) => {
    setCategoryQuery(categoryName); // only affect filtering, NOT the input field
  };
