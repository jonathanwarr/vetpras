...
export default function SearchCategory({ services = [], onCategoryChange }) {
  ...
  return (
    <div className="w-full sm:w-60">
      <label className="mb-3 block text-sm font-bold text-slate-900">Search by Category</label>
      <div className="relative mt-2">
        <Listbox value={selected} onChange={handleSelect}>
          ...
          <ListboxOptions
            transition
            className="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 pb-2 text-base shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm"
          >
