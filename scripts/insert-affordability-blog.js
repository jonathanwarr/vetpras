// Script to insert the affordability crisis blog post
...
const blogPost = {
  title: "Every Week, Another Family's Pet—How Vancouver's Hidden Pricing Gap Is Trapping Pet Owners in the Affordability Crisis",
  ...
  content: `In the first half of 2025, Montreal shelters saw a 32% surge in surrenders. Calgary's waitlist jumped from zero to 200 animals. Toronto's pet food bank usage doubled. And in Vancouver, you're likely sitting in your living room right now, looking at a vet quote you can't quite afford, wondering: **Is this normal? Am I being overcharged? Can I find something cheaper without sacrificing my pet's care?**
...
The pet affordability crisis isn't new—but it's accelerating. A June 2025 Gallup/PetSmart Charities study found that **50% of Canadian pet owners skipped or declined necessary vet care** in the past year. Only 28% were offered alternatives when they asked about cost. Only 21% were offered payment plans, despite 66% saying they'd use interest-free options.

Even more striking: According to a September 2025 Hill's Pet Nutrition report, 72% of prospective pet adopters cite veterinary care as a top 3 expense concern, and **72% say vet costs directly affect their willingness to adopt**.
...
But here's what shelters aren't always saying publicly: **This isn't just about wealthy vs. working-class families.** According to Abacus Data polling (May 2025), 37% of Canadian pet owners call vet fees "unreasonably" high, and even households earning $90k+ report skipping care due to cost.
...
Before you book or pay a quote, **ask these questions:**

1. **"What's included in this quote?"** (Bloodwork? Pain management? Follow-up visits? Complications coverage?)
2. **"Will my pet need pre-surgical bloodwork, and is it included or extra?"** (Older pets or those with health issues often need bloodwork. Some clinics include it; others charge $150–$300 extra.)
3. **"Who will be performing the surgery?"** (Experienced generalist or board-certified specialist? It matters, and so does the price difference.)
4. **"What's your pain management protocol?"** (Single injection vs. multi-day medication changes the quote—and the recovery.)
5. **"What happens if there are complications?"** (Are follow-ups included if something goes wrong?)
6. **"Do you offer payment plans?"** (66% of pet owners say they'd use interest-free payment plans—but only 21% are currently offered them.)
...
- That cheaper clinic might exist 10 minutes away
...
Vetpras is building Vancouver's first crowdsourced vet pricing map. We're collecting anonymized quotes and bills from pet owners like you to make pricing transparent—so the next family doesn't have to guess.
